            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-base">{type.name} Migration</h3>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="flex items-center gap-1.5 text-xs">
                    ...
                    <span className="text-gray-600">{active} Active</span>
                  </div>
                  <div className="flex items-center gap-1.5 text-xs">
                    <CheckCircle size={12} className="text-blue-500" />
                    <span className="text-gray-600">{completed} Done</span>
                  </div>
                  <div className="flex items-center gap-1.5 text-xs">
                    <Clock size={12} className="text-orange-500" />
                    <span className="text-gray-600">{overaged} Overaged</span>
                  </div>
                  <div className="flex items-center gap-1.5 text-xs">
                ...
                <thead className="bg-blue-50/60">
                  <tr>
                    {['Project Name', 'Customer', 'Manager', 'Status', 'Phase', 'SOW End', 'Delay'].map((h) => (
                      <th
                        key={h}
                        className={`py-2.5 px-3 font-medium text-gray-500 text-xs uppercase ${h === 'Project Name' ? 'text-left' : 'text-center'}`}
                      >
                        {h}
                      </th>
                    ))}
