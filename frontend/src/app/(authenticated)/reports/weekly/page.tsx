        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Managers Active', value: wr.summary?.managersWithChanges ?? (new Set(wr.changedThisWeek?.map((p: any) => p.projectManager))).size, color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-900/40', icon: Users },
            ].map((item) => (
          ...
          <Card>
            {activeTab === 'summary' && (
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Period Summary</h3>
                        ...
                        <tbody>
                          {wr.summary.byManager.map((m: any) => (
                            <tr key={m.manager} className="border-t border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30">
                              <td className="py-2 px-3 font-medium text-gray-800 dark:text-gray-200 flex items-center gap-2">
