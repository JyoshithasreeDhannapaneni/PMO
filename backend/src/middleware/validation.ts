...
export const updateProjectSchema = z.object({
  ...
  body: z.object({
    ...
    escalationPriority: z.enum(['LOW', 'MEDIUM', 'HIGH']).optional().nullable(),
    overageAmount: z.union([z.number(), z.string().transform(v => v === "" ? null : Number(v))]).optional().nullable(),
    cloudAddingStart: dateString.optional().nullable().or(z.literal('')),
    cloudAddingEnd: dateString.optional().nullable().or(z.literal('')),
    cloudAddingNotes: z.string().optional().nullable(),
    pilotMigrationStart: dateString.optional().nullable().or(z.literal('')),
    pilotMigrationEnd: dateString.optional().nullable().or(z.literal('')),
    pilotMigrationNotes: z.string().optional().nullable(),
    onetimeMigrationStart: dateString.optional().nullable().or(z.literal('')),
    onetimeMigrationEnd: dateString.optional().nullable().or(z.literal('')),
    onetimeMigrationNotes: z.string().optional().nullable(),
    deltaMigrationStart: dateString.optional().nullable().or(z.literal('')),
    deltaMigrationEnd: dateString.optional().nullable().or(z.literal('')),
    deltaMigrationNotes: z.string().optional().nullable(),
    finalValidationStart: dateString.optional().nullable().or(z.literal('')),
    finalValidationEnd: dateString.optional().nullable().or(z.literal('')),
    finalValidationNotes: z.string().optional().nullable(),
  }),
});
