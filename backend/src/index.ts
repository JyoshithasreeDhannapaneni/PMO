...
async function runMigrations() {
  ...
  // never recomputed afterward, same durability contract as email_hygiene_weekly above.
  await execute(`CREATE TABLE IF NOT EXISTS email_hygiene_monthly (
    id           UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  ...
  const TEAM_MEMBERS: [string, string][] = [
    ...
    ['Ambika.Patil@cloudfuze.com',            'Ambika Patil'],
    ...
    ['Nithish.Bunne@cloudfuze.com',           'Nithish Bunne'],
    ...
    ['Sanjana.Nerella@cloudfuze.com',         'Sanjana Nerella'],
    ...
    ['Tanmai.Arangi@cloudfuze.com',           'Tanmai Arangi'],
    ['Vainateya.Rasala@cloudfuze.com',        'Vainateya Rasala'],
