...
export const callTranscriptController = {
  ...
  rate: asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    await execute(
      `INSERT INTO call_transcript_ratings (event_id, user_email, user_name, subject, meeting_start, rating, rated_by)
       VALUES ($1, $2, $3, $4, $5, $6, $7)
       ON CONFLICT (event_id, user_email)
       DO UPDATE SET rating = $6, subject = $4, meeting_start = $5, rated_by = $7, created_at = NOW()`,
